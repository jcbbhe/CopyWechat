...
public class UserBeanDao extends AbstractDao<UserBean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Headphoto = new Property(1, String.class, "headphoto", false, "HEADPHOTO");
        public final static Property Buserid = new Property(2, Long.class, "buserid", true, "_id");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER_BEAN\" (" + //
                ...
                "\"HEADPHOTO\" TEXT," + // 1: headphoto
                "\"_id\" INTEGER PRIMARY KEY ," + // 2: buserid
    ...
    protected final void bindValues(DatabaseStatement stmt, UserBean entity) {
        ...
        if (headphoto != null) {
            stmt.bindString(2, headphoto);
        }
 
        Long buserid = entity.getBuserid();
        if (buserid != null) {
            stmt.bindLong(3, buserid);
        }
    ...
    public UserBean readEntity(Cursor cursor, int offset) {
        UserBean entity = new UserBean( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // headphoto
            cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2), // buserid
    ...
    public void readEntity(Cursor cursor, UserBean entity, int offset) {
        ...
        entity.setHeadphoto(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setBuserid(cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2));
